...
- Procedural buildings bake at 4x and resource nodes (including wood/food tree
  stamps) at 4x. Tree frames blit their authored alpha silhouettes at bake
  density; berry soft stamps size scratch canvases to the active bake CTM so
  foliage is not upsampled from a 1:1 intermediate. Production
