...
const EVEN_PRODUCTION_BATCH = Object.freeze({ barracks: 4, stable: 2, foundry: 1 });
const EVEN_PRODUCTION_QUEUE_LIMIT = 8;

// Difficulty changes the commander's decisions, never combat stats, production
// cost, training speed or starting resources.
...
export const CPU_DIFFICULTIES = {
  low: {
    ...
    ai: {
      ...
      productionQueueLimit: EVEN_PRODUCTION_QUEUE_LIMIT,
      productionBatch: EVEN_PRODUCTION_BATCH,
...
export const NATIONS = {
  england: {
    ...
    headgear: 'tricorn',
    blurb: 'A balanced 1700s realm with the same economy and troop strength as every side.',
    mults: {},
  },
  ottoman: {
...
export const UNIT_TYPES = {
  ...
  wizard_worker: {
    label: 'Wizards', short: 'Wizard', hp: 38, speed: 54, radius: 5,
  ...
  witch_worker: {
    label: 'Witches', short: 'Witch', hp: 38, speed: 54, radius: 5,
    worker: true, projectileKind: 'arcane',
    range: 160, acquire: 0, reload: 6, dmg: 5, acc: 0.27,
    meleeDmg: 2, meleeRate: 1.5, chase: 0,
    cost: { food: 50 }, trainTime: 6, pop: 1,
  ...
  circus_worker: {
    label: 'Circus Hands', short: 'Circus Hand', hp: 38, speed: 54, radius: 5,
    worker: true,
    range: 160, acquire: 0, reload: 6, dmg: 5, acc: 0.27,
    meleeDmg: 2, meleeRate: 1.5, chase: 0,
    cost: { food: 50 }, trainTime: 6, pop: 1,
  ...
  starwars_mechanic: {
    label: 'StarWars Mechanics', short: 'Mechanic', hp: 38, speed: 54, radius: 5,
  ...
  starwars_robed_villager: {
    label: 'StarWars Villagers', short: 'Robed Villager', hp: 38, speed: 54, radius: 5,
    worker: true, projectileKind: 'plasma',
    range: 160, acquire: 0, reload: 6, dmg: 5, acc: 0.27,
    meleeDmg: 2, meleeRate: 1.5, chase: 0,
    cost: { food: 50 }, trainTime: 6, pop: 1,
  ...
  wizard_duelist: {
    label: 'Wizard Duelists', short: 'Wizard Duelist', hp: 34, speed: 46, radius: 5,
    projectileKind: 'arcane', range: 190, acquire: 275, reload: 4.2, dmg: 11, acc: 0.4,
    meleeDmg: 4, meleeRate: 1.3, chase: 0,
    cost: { food: 28, gold: 18 }, trainTime: 3.2, pop: 1,
  },
  witch_duelist: {
    label: 'Witch Duelists', short: 'Witch Duelist', hp: 48, speed: 45, radius: 5,
    projectileKind: 'arcane', range: 0, acquire: 210, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 10, meleeRate: 1.05, chase: 160,
    cost: { food: 24, wood: 16 }, trainTime: 2.8, pop: 1,
  },
  broom_rider: {
    label: 'Broom Riders', short: 'Broom Rider', hp: 68, speed: 108, radius: 7,
    projectileKind: 'arcane', range: 0, acquire: 340, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 12, meleeRate: 0.92, chase: 260,
    cost: { food: 55, gold: 44 }, trainTime: 5.5, pop: 2,
  },
  moaning_myrtle: {
    label: 'Moaning Myrtles', short: 'Moaning Myrtle', hp: 90, speed: 27, radius: 11,
    projectileKind: 'spectral', range: 670, minRange: 105, acquire: 730,
    reload: 9.5, dmg: 48, acc: 1, splash: 34,
    meleeDmg: 2, meleeRate: 1.6, chase: 0,
    cost: { wood: 70, gold: 105 }, trainTime: 12, pop: 5,
  },
  pennywise: {
    label: 'Pennywises', short: 'Pennywise', hp: 68, speed: 108, radius: 7,
    range: 0, acquire: 340, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 12, meleeRate: 0.92, chase: 260,
    cost: { food: 55, gold: 44 }, trainTime: 5.5, pop: 2,
  },
  art_clown: {
    label: 'Art Clowns', short: 'Art the Clown', hp: 48, speed: 45, radius: 5,
    range: 0, acquire: 210, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 10, meleeRate: 1.05, chase: 160,
    cost: { food: 24, wood: 16 }, trainTime: 2.8, pop: 1,
  },
  twisty_clown: {
    label: 'Twisty Clowns', short: 'Twisty', hp: 48, speed: 45, radius: 5,
    range: 0, acquire: 210, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 10, meleeRate: 1.05, chase: 160,
    cost: { food: 24, wood: 16 }, trainTime: 2.8, pop: 1,
  },
  captain_spaulding: {
    label: 'Captain Spauldings', short: 'Captain Spaulding', hp: 34, speed: 46, radius: 5,
    projectileKind: 'nightmare', range: 190, acquire: 275, reload: 4.2, dmg: 11, acc: 0.4,
    meleeDmg: 4, meleeRate: 1.3, chase: 0,
    cost: { food: 28, gold: 18 }, trainTime: 3.2, pop: 1,
  },
  killer_klown: {
    label: 'Killer Klowns', short: 'Killer Klown', hp: 90, speed: 27, radius: 11,
    projectileKind: 'cotton_candy', range: 670, minRange: 105, acquire: 730,
    reload: 9.5, dmg: 48, acc: 1, splash: 34,
    meleeDmg: 2, meleeRate: 1.6, chase: 0,
    cost: { wood: 70, gold: 105 }, trainTime: 12, pop: 5,
  },
  starwars_sentinel: {
    label: 'StarWars Sentinels', short: 'Sentinel', hp: 34, speed: 46, radius: 5,
    projectileKind: 'plasma', range: 190, acquire: 275, reload: 4.2, dmg: 11, acc: 0.4,
    meleeDmg: 4, meleeRate: 1.3, chase: 0,
    cost: { food: 28, gold: 18 }, trainTime: 3.2, pop: 1,
  },
  starwars_blade_guard: {
    label: 'StarWars Blade Guards', short: 'Blade Guard', hp: 48, speed: 45, radius: 5,
    range: 0, acquire: 210, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 10, meleeRate: 1.05, chase: 160,
    cost: { food: 24, wood: 16 }, trainTime: 2.8, pop: 1,
  },
  starwars_skiff_rider: {
    label: 'StarWars Skiff Riders', short: 'Skiff Rider', hp: 68, speed: 108, radius: 7,
    projectileKind: 'plasma', range: 0, acquire: 340, reload: 0, dmg: 0, acc: 0,
    meleeDmg: 12, meleeRate: 0.92, chase: 260,
    cost: { food: 55, gold: 44 }, trainTime: 5.5, pop: 2,
  },
  starwars_pulse_cannon: {
    label: 'StarWars Pulse Cannons', short: 'Pulse Cannon', hp: 90, speed: 27, radius: 11,
    projectileKind: 'ion', range: 670, minRange: 105, acquire: 730,
    reload: 9.5, dmg: 48, acc: 1, splash: 34,
    meleeDmg: 2, meleeRate: 1.6, chase: 0,
    cost: { wood: 70, gold: 105 }, trainTime: 12, pop: 5,
  },
...
export const BUILDING_TYPES = {
  ...
  house: {
    label: 'House',
    description: '+40 population capacity. Restrained brick residence with sash windows and a hipped tile roof.',
    w: 62, h: 52, radius: 34, visualScale: 1.28, hp: 650, buildTime: 9,
    cost: { wood: 70 }, popCap: 40, hotkey: 'H',
  },
  english_cottage: {
    label: 'Country Cottage',
    description: '+40 population capacity. Limewashed rural stone cottage beneath hand-laid thatch.',
  ...
  english_townhouse: {
    label: 'Brick Townhouse',
    description: '+40 population capacity. Tall Georgian town house with gauged brickwork and sash windows.',
    w: 76, h: 62, radius: 42, visualScale: 1.28, hp: 700, buildTime: 10,
    cost: { wood: 80, stone: 10 }, popCap: 40, hotkey: 'R',
    buildNations: ['england'], housingChoice: true,
  },
  english_mansion: {
    label: 'Palladian Manor',
    description: '+40 population capacity. Symmetrical early-Georgian country manor in classical ashlar.',
  ...
  spooky_house: {
    label: 'Spooky House',
    description: '+40 population capacity. Weathered Georgian Gothick villa with battlements, pinnacles and tracery.',
...
export const NATION_TRAINING_ROSTERS = Object.freeze({
  hogwarts: Object.freeze({
    ...
    stable: Object.freeze(['broom_rider']),
    foundry: Object.freeze(['moaning_myrtle']),
    castle: Object.freeze(['wizard_duelist', 'witch_duelist', 'broom_rider', 'moaning_myrtle']),
  }),
